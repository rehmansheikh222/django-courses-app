...
"""
django-courses-app documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'django-courses-app',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/rehmansheikh222/django-courses-app",
...
#
# html_title = 'django-courses-app v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'django_courses_app'),
                os.path.join(root_path, 'django_courses_app/migrations')])
